        ...
        <main id="pc-list-results">
          <section className="pc-list-page-intro" style={{
            ...
            <p className="pc-list-page-intro__description" style={{
              ...
              ノートPCを中心に、価格、CPU、GPU、メモリ、SSD、重量、バッテリーをまとめて比較します。ゲーム向けや軽量モバイルなど、用途が決まっている場合は専用ランキングから見ると候補を絞りやすくなります。
            </p>
            <div
              aria-label="用途別PCランキング"
              style={{
                marginTop: '16px',
                display: 'flex',
            ...
            >
              {[
                { href: '/pc-list/mobile', label: '軽量モバイルPC' },
                { href: '/pc-list/gaming', label: 'ゲーミングPC' },
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: '16px',
            padding: '24px',
            boxShadow: '0 18px 30px rgba(148, 163, 184, 0.2)',
            color: '#1f2937'
          }}>
            <h2 style={{
              margin: '0 0 6px 0',
            ...
            <p style={{ margin: '0 0 12px 0', color: '#475569', lineHeight: 1.8 }}>
